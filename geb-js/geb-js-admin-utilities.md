...
+ **new GebAdmin**\(`network`: GebDeployment, `provider`: GebProviderInterface \| Provider\): [_GebAdmin_](geb-js-admin-utilities.md)

_Defined in_ [_packages/geb-admin/src/geb-admin.ts:51_](https://github.com/reflexer-labs/geb.js/blob/198bcb4/packages/geb-admin/src/geb-admin.ts#L51)
...
**Returns:** [_GebAdmin_](geb-js-admin-utilities.md)
...
_Inherited from_ [_GebAdmin_](geb-js-admin-utilities.md)_._[_contracts_](geb-js-admin-utilities.md#contracts)
...
_Inherited from_ [_GebAdmin_](geb-js-admin-utilities.md)_._[_deployProxy_](geb-js-admin-utilities.md#deployproxy)
...
_Inherited from_ [_GebAdmin_](geb-js-admin-utilities.md)_._[_getErc20Contract_](geb-js-admin-utilities.md#geterc20contract)
...
_Inherited from_ [_GebAdmin_](geb-js-admin-utilities.md)_._[_getProxyActionGlobalSettlement_](geb-js-admin-utilities.md#getproxyactionglobalsettlement)
...
_Inherited from_ [_GebAdmin_](geb-js-admin-utilities.md)_._[_getSafe_](geb-js-admin-utilities.md#getsafe)
...
_Inherited from_ [_GebAdmin_](geb-js-admin-utilities.md)_._[_multiCall_](geb-js-admin-utilities.md#multicall)
