---
description: Dipping your toes into GEB.js
---
...
// Note: Before doing this you need to create a proxy for yourself
...
tx.gasPrice = ethers.BigNumber.from('280').mul('1000000000') // Set the gas price to 280 Gwei
...
Deploy a GEB proxy for your address:
